...
```sh
pip install OrbDex_cli
```

Or using Poetry:

```sh
poetry add OrbDex_cli
```
...
```sh
OrbDex_cli print-account-info ACCOUNT_ADDRESS --env ENVIRONMENT
```

### Add Guardian

```sh
OrbDex_cli add-guardian PUB_KEY --env ENVIRONMENT
```

### Add Guardian Backup

```sh
OrbDex_cli add-guardian-backup PUB_KEY --env ENVIRONMENT
```

### Change Signer

```sh
OrbDex_cli change-signer PUB_KEY --env ENVIRONMENT
```

### Sign Invoke Transaction

```sh
OrbDex_cli sign-invoke-tx FILE_PATH --env ENVIRONMENT
```

### Submit Invoke Transaction

```sh
OrbDex_cli submit-invoke-tx TX_FILE_PATH SIG_FILES --env ENVIRONMENT
```

### Trigger Escape Guardian

```
OrbDex_cli trigger-escape-guardian --env ENVIRONMENT
```
...
```sh
git clone https://github.com/tradeOrbDex/OrbDex_cli.git
cd OrbDex_cli
```
